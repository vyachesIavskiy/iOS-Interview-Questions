...
### 28. 🟡 Что такое `lazy var`? Для чего она используется?
...
Здесь на помощь нам приходят ключевые слова `any` и `some`. Данные два ключевых слова решают одну и ту же проблему, но немного по-разномуу.  
