...
### 21. 🟢 Назовите типы данных для работы с коллекциями, которые есть в Swift
...
### 24. 🟡 Что такое `weak` и `onowned`? Чем они отличаются?
...
### 26. 🟡 Что такое lazy var?

<br/>

### 27. 🟡 Чем отличаются `escaping` кложуры от `nonescaping`?

<br/>

### 28. 🟡 Что такое `associated type`? Для чего он используется?

<br/>

### 29. 🟡 Какие ограничения есть для протоколов, у которых есть `associated type`?

<br/>

### 30. 🟡 Сравните по скорости чтение/запись/поиск в разных коллекциях в Swift
...
### 32. 🟡 Чем отличается `for loop` от `foreach`?
...
### 36. 🔴 Что такое `generics`? Для чего они используются?
